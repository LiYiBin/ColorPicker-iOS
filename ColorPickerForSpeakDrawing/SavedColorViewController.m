...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    float r = [[color valueForKey:PATCH_COLOR_RED] floatValue];
    float g = [[color valueForKey:PATCH_COLOR_GREEN] floatValue];
    float b = [[color valueForKey:PATCH_COLOR_BLUE] floatValue];
